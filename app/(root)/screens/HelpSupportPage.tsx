...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 20, fontWeight: 'bold', color: '#130001' },
  ...
  cardTitle: { fontWeight: '600', marginTop: 8, color: '#130001' },
  ...
  supportHoursTitle: { fontWeight: '600', color: '#DADADA', marginBottom: 8,fontSize: 15 },
  ...
  submitButtonText: { color: '#DADADA', fontWeight: '600' },
  ...
  title: { fontSize: 20, fontWeight: 'bold', color: '#130001', marginBottom: 8 },
