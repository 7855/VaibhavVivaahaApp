...
const styles = StyleSheet.create({
  ...
  greetingMuted: { fontSize: 11, fontFamily: 'Rubik-Medium', color: '#475569', letterSpacing: -0.1, marginBottom: 1 },
  greetingName: { fontSize: 19, fontFamily: 'Rubik-ExtraBold', color: '#0f1724', letterSpacing: -0.5, lineHeight: 23 },
  greetingNameLight: { fontFamily: 'Rubik-Medium', color: '#334155' },
  ...
  tierPillText: { fontSize: 11, fontFamily: 'Rubik-Bold', letterSpacing: -0.1 },
  verifiedPill: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 100, gap: 4 },
  verifiedPillText: { fontSize: 11, fontFamily: 'Rubik-Bold', color: '#fff', letterSpacing: -0.1 },
  ...
  bellBadgeText: { fontSize: 9, fontFamily: 'Rubik-ExtraBold', color: '#fff', letterSpacing: -0.1 },
});
